...
<div class="max-w-5xl mx-auto">
  <div class="mb-6">
    ...
    <p class="mt-2 text-sm text-gray-500">Select scholars and create a bulk billing for submission to the office</p>
  </div>
  ...
  <form method="post" action="<?= site_url('school/billing/store') ?>" class="space-y-6">
    <?= csrf_field() ?>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label for="batch_label" class="block text-sm font-medium text-gray-700 mb-1">Batch Label*</label>
      ...
      <div class="mt-4">
        ...
        <textarea id="remarks" name="remarks" rows="2" placeholder="Add any additional notes..."
                  class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
      </div>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <button type="button" onclick="toggleAll()" class="px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200">
            Select All
          </button>
        </div>
      </div>
    ...
    <div class="flex justify-end gap-3">
      <a href="<?= site_url('school/billing') ?>" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
        Cancel
      </a>
...
function updateCount() {
  ...
  document.getElementById('running-total').textContent = '₱' + total.toLocaleString('en-PH', {minimumFractionDigits: 2, maximumFractionDigits: 2});
}
